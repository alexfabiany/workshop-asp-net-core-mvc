...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d5 = new Department(5, "Mobile");

            Seller s1 = new Seller(1, "Bob Brown", "bobbrown@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "mariagreen@gmail.com", new DateTime(1979, 12, 31), 1258.45, d3);
            Seller s3 = new Seller(3, "Alex Grey", "alexgrey@gmail.com", new DateTime(1988, 1, 15), 2200.0, d5);
            Seller s4 = new Seller(4, "Martha Red", "marthar@gmail.com", new DateTime(1993, 11, 30), 3000.0, d3);
            Seller s5 = new Seller(5, "Donald Blue", "donaldblue@gmail.com", new DateTime(2000, 1, 9), 4000.0, d4);
            ...
            SalesRecord r31 = new SalesRecord(31, new DateTime(2018, 9, 25), 11000.0, SaleStatus.Billed, s3);
            SalesRecord r32 = new SalesRecord(32, new DateTime(2021, 1, 12), 1234.34, SaleStatus.Pending, s2);
            SalesRecord r33 = new SalesRecord(33, new DateTime(2021, 3, 15), 7435.3, SaleStatus.Pending, s2);
